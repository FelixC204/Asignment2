...
<div class="flex h-screen w-full items-center justify-center bg-[#800080]">
    <div class="w-[400px] rounded-lg bg-white p-8 text-center shadow-lg">
      ...
      <form>
        ...
        <button class="inline-flex items-center justify-center whitespace-nowrap text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary hover:bg-primary/90 h-10 px-4 mb-4 w-full rounded bg-gradient-to-r from-red-500 to-yellow-500 py-2 text-white">
          Login
        </button>
        <div>
